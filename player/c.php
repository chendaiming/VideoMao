...
<script type="text/javascript">
	var vid = window.parent.frames.MacPlayer.PlayUrl;
	var h =   window.parent.frames.MacPlayer.Height;
    ...
    if (isiPad) {
        document.getElementById('a1').innerHTML = '<video src="'+purl+'" controls="controls" autoplay="autoplay" width="100%" height="'+h+'" style="psotion:relative;""></video>'
	}else{
	    CKobject.embedSWF('ckplayer/ckplayer.swf','a1','ckplayer_a1','100%',h,flashvars,params);
	}
  </script>
</body>
</html>
